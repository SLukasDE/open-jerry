...
#ifndef JERRY_CONFIG_MAIN_APPLICATIONS_H_
#define JERRY_CONFIG_MAIN_APPLICATIONS_H_
...
private:
	...
	std::vector<std::unique_ptr<application::Context>> applications;
};
...
#endif /* JERRY_CONFIG_MAIN_APPLICATIONS_H_ */
