...
#ifndef JERRY_ENGINE_BASIC_ENTRY_H_
#define JERRY_ENGINE_BASIC_ENTRY_H_
...
public:
	...
	virtual esl::io::Input accept(esl::com::basic::server::RequestContext& requestContext) = 0;
};
...
#endif /* JERRY_ENGINE_BASIC_ENTRY_H_ */
