...
#ifndef JERRY_ENGINE_HTTP_REQUESTCONTEXT_H_
#define JERRY_ENGINE_HTTP_REQUESTCONTEXT_H_

#include <jerry/engine/http/Connection.h>
...
#endif /* JERRY_ENGINE_HTTP_REQUESTCONTEXT_H_ */
