...
esl::io::Input Listener::createRequestHandler(esl::messaging::server::RequestContext& baseRequestContext) {
...
/*
void Listener::registerHandlerData(const std::string& queueName, esl::messaging::server::messagehandler::Interface::CreateMessageHandler createMessageHandler, const Context& context) {
