...
RequestContext::RequestContext(esl::messaging::server::RequestContext& aBaseRequestContext, Writer& aWriter, const Context& aContext)
: baseRequestContext(aBaseRequestContext),
  writer(aWriter),
  context(aContext)
{ }

esl::io::Input RequestContext::createInput(std::unique_ptr<Writer>& writer, esl::messaging::server::requesthandler::Interface::CreateInput createInput) {
...
const esl::messaging::server::Request& RequestContext::getRequest() const {
