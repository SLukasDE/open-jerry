...
#ifndef JERRY_ENGINE_MESSAGING_CONTEXT_H_
#define JERRY_ENGINE_MESSAGING_CONTEXT_H_
...
public:
	...
	Endpoint& addEndpoint(std::string queueName, bool inheritObjects);
	void addMessageHandler(const std::string& implementation);
...
#endif /* JERRY_ENGINE_MESSAGING_CONTEXT_H_ */
