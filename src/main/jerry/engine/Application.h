...
#ifndef JERRY_ENGINE_APPLICATION_H_
#define JERRY_ENGINE_APPLICATION_H_
...
class Application : public ObjectContext {
public:
	...
	http::Context& addHttpListener();
	http::Context* getHttpListener();
...
#endif /* JERRY_ENGINE_APPLICATION_H_ */
