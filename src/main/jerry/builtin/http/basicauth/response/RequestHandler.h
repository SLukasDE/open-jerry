...
#ifndef JERRY_BUILTIN_HTTP_BASICAUTH_RESPONSE_REQUESTHANDLER_H_
#define JERRY_BUILTIN_HTTP_BASICAUTH_RESPONSE_REQUESTHANDLER_H_
...
public:
	static inline const char* getImplementation() {
		return "jerry/basicauth-response";
	}
...
#endif /* JERRY_BUILTIN_HTTP_BASICAUTH_RESPONSE_REQUESTHANDLER_H_ */
