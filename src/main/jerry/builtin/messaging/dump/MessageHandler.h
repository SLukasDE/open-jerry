...
#ifndef JERRY_BUILTIN_MESSAGING_DUMP_MESSAGEHANDLER_H_
#define JERRY_BUILTIN_MESSAGING_DUMP_MESSAGEHANDLER_H_
...
public:
	...
	MessageHandler(esl::messaging::MessageContext& messageContext, const Settings& settings);
...
#endif /* JERRY_BUILTIN_MESSAGING_DUMP_MESSAGEHANDLER_H_ */
