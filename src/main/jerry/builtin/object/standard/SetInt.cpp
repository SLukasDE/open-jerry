...
std::unique_ptr<esl::object::Interface::Object> SetInt::create(const std::vector<std::pair<std::string, std::string>>& settings) {
	return std::unique_ptr<esl::object::Interface::Object>(new SetInt(settings));
}
