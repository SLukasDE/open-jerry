...
#ifndef OPENJERRY_CONFIG_HTTP_EXCEPTIONS_H_
#define OPENJERRY_CONFIG_HTTP_EXCEPTIONS_H_

#include <openjerry/config/Config.h>
#include <openjerry/config/http/ExceptionDocument.h>
...
#endif /* OPENJERRY_CONFIG_HTTP_EXCEPTIONS_H_ */
