...
#ifndef OPENJERRY_CONFIG_OBJECT_H_
#define OPENJERRY_CONFIG_OBJECT_H_
...
public:
	...
	void install(esl::object::Context& engineObjectContext) const;
...
#endif /* OPENJERRY_CONFIG_OBJECT_H_ */
