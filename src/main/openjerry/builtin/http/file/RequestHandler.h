...
#ifndef OPENJERRY_BUILTIN_HTTP_FILE_REQUESTHANDLER_H_
#define OPENJERRY_BUILTIN_HTTP_FILE_REQUESTHANDLER_H_
...
#endif /* OPENJERRY_BUILTIN_HTTP_FILE_REQUESTHANDLER_H_ */
