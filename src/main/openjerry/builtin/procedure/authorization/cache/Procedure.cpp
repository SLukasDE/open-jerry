...
namespace {
Logger logger("openjerry::builtin::procedure::authorization::cache::Procedure");
} /* anonymous namespace */
...
void Procedure::initializeContext(esl::object::Context& objectContext) {
	authorizingProcedure = objectContext.findObject<esl::object::Procedure>(authorizingProcedureId);
